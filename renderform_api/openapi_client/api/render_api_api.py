...
class RenderAPIApi:
    ...
    def render_v2(
        ...
        output: Annotated[Optional[StrictStr], Field(description="Output format")] = None,
        ...
        _param = self._render_v2_serialize(
            x_api_key=x_api_key,
    ...
    @validate_call
    def render_v2_without_preload_content(
        self,
        x_api_key: StrictStr,
        render_request: RenderRequest,
        output: Annotated[Optional[StrictStr], Field(description="Output format")] = None,
