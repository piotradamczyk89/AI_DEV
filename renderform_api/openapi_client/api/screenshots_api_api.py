...
class ScreenshotsAPIApi:
    ...
    def create_screenshot(
        self,
        x_api_key: StrictStr,
        create_screenshot_request: CreateScreenshotRequest,
        ...
        :type x_api_key: str
        :param create_screenshot_request: (required)
        :type create_screenshot_request: CreateScreenshotRequest
        ...
        _param = self._create_screenshot_serialize(
            x_api_key=x_api_key,
            create_screenshot_request=create_screenshot_request,
    ...
    def create_screenshot_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateScreenshotResponse]:
        """create_screenshot
    ...
    def _create_screenshot_serialize(
        ...
        if create_screenshot_request is not None:
            _body_params = create_screenshot_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/screenshots',
