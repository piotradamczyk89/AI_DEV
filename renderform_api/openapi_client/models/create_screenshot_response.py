...
class CreateScreenshotResponse(BaseModel):
    ...
    request: Optional[CreateScreenshotRequest] = None
    __properties: ClassVar[List[str]] = ["requestId", "href", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "href": obj.get("href"),
            "request": CreateScreenshotRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
