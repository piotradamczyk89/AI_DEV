...
class PageRenderResultItem(BaseModel):
    """
    ...
    content: Optional[List[RenderResultItem]] = None
    number: Optional[StrictInt] = None
    sort: Optional[SortObject] = None
    first: Optional[StrictBool] = None
    last: Optional[StrictBool] = None
    empty: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["totalPages", "totalElements", "pageable", "numberOfElements", "size", "content", "number", "sort", "first", "last", "empty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [RenderResultItem.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
